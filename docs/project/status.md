...
- handler specialization for captureless, non-suspending futures with a custom residual effect,
  including `Future(E)` where-predicate inference and effectful trait-method inlining;

...
pub let add_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `-=`.
pub let sub_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `*=`.
pub let mul_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `/=`.
pub let div_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `%=`.
pub let rem_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `&=`.
pub let bit_and_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `|=`.
pub let bit_or_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `^=`.
pub let bit_xor_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `<<=`.
pub let shl_assign_operator(comptime rhs: type) = trait {
...
/// Trait backing compound `>>=`.
pub let shr_assign_operator(comptime rhs: type) = trait {

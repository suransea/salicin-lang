...
structural payload remainder；v0.20 完成 guarded transfer 的延迟提交。
...
当前 v0.20 已完成第一步中的 CFG、结果 storage、显式 transfer、完整静态 forest、move-state fixed
...
binding。Function capture environment、borrowed mutation 和 closure cleanup 仍 pending；只有
v0.16–v0.20 明确覆盖的

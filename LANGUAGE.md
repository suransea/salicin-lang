...
当前 v0.21 已完成第一步中的 CFG、结果 storage、显式 transfer、完整静态 forest、move-state fixed
...
binding，v0.21 补齐本地 `FnOnce` nominal resource environment。普通 partial/escaping callable、
borrowed mutation 仍 pending；只有 v0.16–v0.21 明确覆盖的
